    ...
    return <>
        <div className="h-full columns-2 gap-0 p-5 mx-5">
            <div className="break-inside-avoid-column max-w-full m-6 border rounded-xl p-5 bg-slate-600 transition-transform ease-linear duration-75 hover:translate-y-1 hover:shadow-md hover:shadow-gray-400">
                <h1 className="text-2xl">{data[0].attraction}</h1>
                <h2 className="mt-2 text-xl">{data[0].city}</h2>
                <h4 className="mt-2 text-md font-light">{data[0].brief}</h4>
                <div className="flex w-full items-center justify-end">
                    <button className="mt-2 border rounded-md p-1 hover:bg-blue-900 hover:text-gray-200">Pick a date</button>
                </div>
            </div>
            <div className="break-inside-avoid-column max-w-full m-6 border rounded-xl p-5 bg-slate-600 transition-transform ease-linear duration-75 hover:translate-y-1 hover:shadow-md hover:shadow-gray-400">
