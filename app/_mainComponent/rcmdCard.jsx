...
export default function RcmdLinkedCard(content){
    ...
    return (
        <Link key={id} href={linkUrl} style={{'--image-url': `url(${bgUrl})`}} className="shrink-0 border rounded w-[60vh] h-[27vh] overflow-hidden transition-transform ease-linear duration-75 hover:translate-y-1 hover:shadow-md hover:shadow-gray-400 bg-cover bg-[image:var(--image-url)]">
