          ...
          <form onSubmit={onSubmit}>
            <div className="flex flex-col gap-8 justify-center items-center">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input className="border rounded-md p-2 text-black font-light" type="text" id="email" name="email" onChange={handleChange} required/>
              </div>
              <div className="flex flex-col gap-2">
                <label className="text-white" htmlFor="password">Password</label>
                <input className="border rounded-md p-2 text-black font-light" type="password" id="password" name="password" onChange={handleChange} required/>
              </div>
              <div className="flex w-full gap-10">
                <button type="submit" className="bg-slate-600 hover:bg-slate-700 text-white font-bold py-2 px-5 rounded">
                  Login
                </button>
                <Link href="#" className="bg-slate-600 hover:bg-slate-700 text-white font-bold py-2 px-5 rounded">
                  Register
                </Link>
              </div>
            </div>
