        ...
        <div className="flex-col flex h-[calc(100vh-3.75rem)]">
            ...
            <footer className="flex max-h-[10%] w-full justify-between bg-slate-700 z-10 bottom-0 sticky flex-col p-2">
                    <form ref={ref} onSubmit={(e)=>{handleResponse(e,chat); ref.current?.reset()} }>
                        <input type="text" id="response" name="response" required className="w-[90%] m-2 p-2 border rounded-md bg-slate-800 text-white" onChange={handleChange} title={""} placeholder={loaded?"Let our AI know your interests!":"Loading..."} disabled={!loaded}/>
